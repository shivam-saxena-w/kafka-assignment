...
public class Consumer {
    ...
    public static void consumer() {
        ...
        properties.put("value.deserializer", "com.devanshu.deserializer.UserDeserializer");
        ...
        try{
            ...
            while (true){
                ...
                for (ConsumerRecord<String, User> record: records){
                    ...
                    BufferedWriter buffer = new BufferedWriter(new FileWriter("DataProduced.txt", true));
                    buffer.write(record.value()+"\n"); // this code will write the user records in DataProduced.txt file.
                    buffer.close();
                }
            }
        }catch (Exception e){
